...
\begin{figure}[H]
    \begin{minipage}[b]{0.6\textwidth}
        \begin{tabular}{c}
       % \Pic[0.3]{SRTM30_dem.jpg}\\
	\includegraphics[width=8cm,height=9cm,keepaspectratio]{figs_pdf/Aster_galeras.jpg}\\
        (a)
        \end{tabular}
    \end{minipage}
%\hfill
	...
	\includegraphics[width=8cm,height=9cm,keepaspectratio]{figs_pdf/topsar30m.jpg}\\
        (b)
        \end{tabular}
    \end{minipage} 
    \begin{minipage}[b]{0.6\textwidth}
